...
export default function ProjectInfoSection({
  ...
  return (
    <section className="relative rounded-3xl bg-white px-8 py-8 text-left shadow-2xl">
      <button
        type="button"
        onClick={onClose}
      ...
      <div className="mb-8 pr-10">
        <div className="flex items-center gap-3">
          <h2 className="text-3xl font-bold tracking-tight">AI 분석 결과</h2>
...
className="w-full resize-none overflow-hidden rounded-lg border border-gray-300 px-3 py-2 text-sm outline-none transition focus:border-black"/>
        ...
        <div>
          ...
          {isLoadingRepoData || isAIWriting ? (
            <div className="animate-pulse space-y-2 rounded-xl border border-gray-200 px-4 py-3">
            ...
            <textarea
              ...
              rows={1}
              className="w-full resize-none overflow-hidden rounded-lg border border-gray-300 px-3 py-2 text-sm leading-6 outline-none transition focus:border-black"
            />
          )}
        </div>
        ...
        <div>
          ...
          {isLoadingRepoData || isAIWriting ? (
            <div className="animate-pulse space-y-2 rounded-2xl border border-gray-200 px-4 py-3">
              <div className="h-3.5 w-full rounded bg-gray-200" />
        ...
        <div>
          ...
          {isLoadingRepoData ? (
            <div className="flex min-h-13 animate-pulse flex-wrap gap-2 rounded-xl border border-gray-200 px-4 py-3">
        ...
        <div>
          ...
          <div className="relative flex aspect-video w-full items-center justify-center overflow-hidden rounded-2xl border-2 border-dashed border-gray-200 bg-gray-50">
        ...
        <button
          type="button"
          onClick={onClose}
          className="mt-3 h-13 w-full rounded-2xl bg-black text-[15px] font-semibold text-white transition hover:bg-gray-800"
        >
          저장하기
        </button>
      </div>
